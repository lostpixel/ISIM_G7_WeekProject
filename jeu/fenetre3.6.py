...
def inscription():      
    ...
    btn_valider.pack(side=LEFT, padx=10, pady=10)
            ...
            #bouton annuler
    btn_annuler=Button(frame_btn_utilisateur, text="Annuler", width=15, relief=GROOVE, bg="#990505", fg="white", cursor="spraycan", command=quitter)
...
frame_option.configure(bg="#151515")
frame_mode=Frame() #frame_option
frame_mode.configure(bg="#151515", ) #fg="green"
...
btn_apocalypse=Button(rame_niveau, width=20, text="Apocalypse", relief=GROOVE, bg="#990505", fg="white", cursor="spraycan")
btn_apocalypse.pack()
frame_niveau.grid(row=0, column=0, padx=5, pady=5)

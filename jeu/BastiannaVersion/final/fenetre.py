...
++++++++++++ STRUCURE DU FICHIER ++++++++++++++++++++++++
- IMPORTATION : tkinter - timeit - Plateau - user - json
- DECLARTION VARIABLE (b - labels - PATH)
- FONCTION create_plateau ( closeFen() + ClicGauche() + ClicDroit() )
- FONCTION niveau
- FONCTION resultat
- FONCTION regle_jeu
    ...
    if len(label_nom['text']) != 0:
        try : 
            ...
            def ClicDroit (ref):
                ...
                else : b[ref].config(image=caseVide)
                print("Drape !")
...
class appTK:
    def __init__(self, master):
        ...
        global label_nom
        label_nom=Label(frame_joueur, width=20, bg="#151515", fg="white", text='')
        label_nom.pack()
        ...
        def updateTime():   #fonction pour le timer
            ...
            canvas_times.itemconfigure(text_clock, text=str_time, font=("42"), fill=("white"))
